...
const KanbanBoard = ({ data }) => {
  ...
  return (
    <div className={`flex flex-col w-full `}>
      <div className={`${theme ? "bg-white" : "bg-gray-700"} sticky flex flex-row justify-between items-center p-4 `}>

        <div onClick={() => setOpen(!open)} className={`${theme ? "bg-white" : "bg-gray-700"} py-2 px-4 flex justify-between items-center gap-1 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-[12px] border-[1px] bg-white`}>
      ...
      <div className={`${theme ? " bg-gray-300" : "bg-black"} h-screen grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 justify-around w-full gap-4 p-4`}>
